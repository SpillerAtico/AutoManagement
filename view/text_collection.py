...
crew_expenses_f = "Расходы, связанные с содержанием экипажа судна в прямом"  # Ээккр.пр = mэк * 18 * tкрпр
crew_expenses_r = "Расходы, связанные с содержанием экипажа судна в обратном"  # Ээккр.пр = mэк * 18 * tкрпр
...
consumption_r = "Расходы за прямое направление"
